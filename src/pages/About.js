                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <p className="text-grey-500 font-xssss fw-500 lh-26 pe-lg-5 me-lg-5">We believe everyone deserves to have a website or online store. Innovation and simplicity makes us happy: our goal is to remove any technical or financial barriers that can prevent business owners from making their own website.</p>

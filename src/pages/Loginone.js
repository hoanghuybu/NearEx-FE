                                ...
                                <div className="card-body rounded-0 text-start p-4">
                                    ...
                                    <form>
                                        ...
                                        <div className="form-check text-start mb-3">
                                            ...
                                            <a
                                                href="/forgotone"
                                                className="fw-600 font-xssss text-grey-700 white-text mt-1 float-right ms-1"
                                            >
                                    ...
                                    <div className="col-sm-12 p-0 text-center mt-2 mb-0">
                                        ...
                                        <div className="form-group mb-1">
                                            <a
                                                href="/Loginone"
                                                className="text-start style2-input text-grey-900 fw-600 font-xsss bg-greylight border-0 p-0 mb-2"
                                            >
                                                <img
                                                    src="assets/images/icon-1.png"
                                                    alt="icon"
                                                    className="ms-2 w-40 mb-1 me-lg-5 me-3"
                                                />{' '}
                                                Sign in with Google
                                            </a>
                                        </div>
                                        <div className="form-group mb-1">
                                            <a
                                                href="/Loginone"
                                                className="text-start style2-input text-white fw-600 font-xsss bg-twiiter border-0 p-0 "
                                            >
                                                <img

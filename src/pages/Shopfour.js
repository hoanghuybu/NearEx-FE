                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div
                                    className="card d-flex flex-wrap flex-row w-100 p-lg-5 p-4 border-0 bg-image-cover bg-image-center mb-3"
                                    style={{ backgroundImage: `url("assets/images/slider-12.jpg")` }}
                                >
                                    <div className="col-lg-5 col-md-12">
                                        <h2 className="fw-700 display1-size display1-sm-size ls-0 text-grey-900 mb-0">
                                            Choose the best <span className="text-current">healthier way</span> of life
                                        </h2>
                                        <span className="text-grey-700 fw-500 font-xssss mt-1 d-block">
                            ...
                            <div className="col-lg-8">
                                <div className="row m-0">
                                    <div className="card d-flex flex-row justify-content-start p-3 bg-greylight border-0 mb-3">
                                        ...
                                        <select
                                            className="form-select ms-auto float-end"

                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-3 pe-lg-0 d-none d-lg-block lower-header z-index-2">
                                    <ul className="dropdown-menu show w-100 posr border-0 mt-0 h-100 pt-2 p-3 shadow-none">
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Biscuits  Snacks</a>
                                            <ul className="sub-menu">
                                                <li><a className="dropdown-item" href="/">Cuts & Sprouts</a></li>
                                                <li><a className="dropdown-item" href="/">Fruits  Vegetables </a></li>
                                                <li><a className="dropdown-item" href="/">Grocery  Staples </a></li>
                                                <li><a className="dropdown-item" href="/">Household Needs </a></li>
                                                <li><a className="dropdown-item" href="/">Meats  Seafood </a></li>
                                                <li><a className="dropdown-item" href="/">Fresh Fruits</a></li>
                                                <li><a className="dropdown-item" href="/">Fresh Vegetables</a></li>
                                                <li><a className="dropdown-item" href="/">Herbs & Seasonings</a></li>
                                                <li><a className="dropdown-item" href="/">Packaged Produce</a></li>
                                                <li><a className="dropdown-item" href="/">Party Trays</a></li>
                                            </ul>
                                        </li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Breads  Bakery </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Breakfast  Dairy </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Frozen Foods </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Fruits  Vegetables </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Grocery  Staples </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Household Needs </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Meats  Seafood </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Fruits  Vegetables </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Grocery  Staples </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Household Needs </a></li>
                                        <li><a className="dropdown-item dropdown-toggle" href="/">Meats  Seafood </a></li>
                                ...
                                <div className="col-lg-3 pe-lg-0 d-none d-lg-block">
                                    ...
                                    <div className="card bg-white rounded-6 mb-3 border-0 p-3">
                                        <div className="col-lg-12">
                                            <h4 className="fw-700 d-flex font-xsss mb-1 mt-2">Trend Product <i className="feather-chevrons-right text-grey-500 font-xs ms-auto"></i></h4>
                                        </div>

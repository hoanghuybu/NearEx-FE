...
const dealProduct = [
    ...
    { imageUrl: 'p.png', title: 'Assorted Donuts Salted ', price: '40', weight: '100 gm'},
]
            ...
            <Fragment> 
                ...
                <div className="product-wrapper pt-4 pb-4">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <h4 className="fw-700 font-sm mb-4 mt-2 d-flex lh-18">Trend  Products <a href="/g-4" className="ms-auto text-grey-500 fw-600 text-uppercase font-xsssss border-bottom ls-3">view all</a></h4>
                            </div>
                        </div>
                        <div className="border rounded-6 ovh bg-white">
                            <div className="row">

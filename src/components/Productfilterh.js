                ...
                <div className="row">
                    <div className={`${gird}`}>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckDrinks1">
                                Drinks
                            </label>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckSnacks2">
                                Snacks &amp; Biscuits
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckBreads3">
                                Breads &amp; Bakery
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            <input
                                ...
                                type="checkbox"
                                value="Breakfast"
                                id="flexCheckBreakfast5"
                            />
                            <label className="form-check-label" htmlFor="flexCheckBreakfast5">
                                Breakfast &amp; Dairy
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckFrozen5">
                                Frozen Foods
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckFruits6">
                                Fruits &amp; Vegetables
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            <input
                                ...
                                type="checkbox"
                                value="Grocery"
                                id="flexCheckGrocery6"
                            />
                            <label className="form-check-label" htmlFor="flexCheckGrocery6">
                                Grocery &amp; Staples
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            <input
                                ...
                                type="checkbox"
                                value="Household"
                                id="flexCheckHousehold7"
                            />
                            <label className="form-check-label" htmlFor="flexCheckHousehold7">
                                Household Needs
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckMeats8">
                                Meats &amp; Seafood
                            </label>
                            <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                        </div>
                    ...
                    <div className={`${gird}`}>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckStock11">
                                In Stock
                            </label>
                        </div>
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="Snacks" id="flexCheckSlae12" />
                            <label className="form-check-label" htmlFor="flexCheckSlae12">
                                On Sale
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckStock1">
                                ...
                                <img
                                    ...
                                    alt="star"
                                    className="w-15 me-1 float-start mt-1"
                                />{' '}

        ...
        return (
            <div className={`footer ${divClass}`}>
                    ...
                    <div className="container pt-5 pb-4">
                        <div className="row">
                            <div className="col-lg-5 mb-3 text-center text-sm-start text-start">
                                <h4 className="fw-700 font-sm text-uppercase ls-0 mb-0 mt-2  lh-24">
                                    Subscribe to our newsletter{' '}
                                </h4>
                                <span className="font-xsssss fw-500 text-grey-500">
                            ...
                            <div className="col-lg-7 mb-3 text-start">
                                <form className="w-100 float-left rounded-lg overflow-hidden">
                                    ...
                                    />
                                    <button className="border-0 bg-current text-white h60 form-control p-0 w-xs-100  rounded-0 float-end d-block w-25 font-xsssss fw-700 ls-3  text-uppercase">
                                        Submit
                                    </button>
                                </form>
                            </div>
                ...
                <div className="lower-footer bg-white pt-5 pb-3">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-4 text-center text-sm-start xs-mb-3">
                                <Link to="/">
                            ...
                            <div className="col-md-8 text-center text-sm-end xs-mb-3">
                                ...
                                <Link to="/" className="btn-round btn-round-md z-index-1 me-1 bg-twiiter">
                                    <i className="ti-twitter-alt text-white"></i>
                                </Link>
                                <Link to="/" className="btn-round btn-round-md z-index-1 me-1 bg-linkedin">
                                    <i className="ti-linkedin text-white"></i>
                                </Link>
                                <Link to="/" className="btn-round btn-round-md z-index-1 bg-instagram">

...
class Dashnav extends Component {
    render() {
        ...
        return (
            <div className="das-nav md-mt-6 p-0 bg-current-shade bg-image-bottomcenter bg-image-cover" style={{backgroundImage: `url("https://via.placeholder.com/1900x300.png")`}}>

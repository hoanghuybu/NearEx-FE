...
class Addbannerfour extends Component {
    render() {
        ...
        return (
            <div
                className="card d-flex align-items-center justify-content-sm-center flex-column border-0 h-200 w-100 rounded-6 mt-3 bg-image-cover p-4"
            ...
            >
                <div className="p-0 pe-3 mt-auto w-50">
                    ...
                    <a href="/" className="fw-700 ls-3 text-grey-900 font-xsssss">
                        SHOP NOW
                    </a>
                </div>
            </div>

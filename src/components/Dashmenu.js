        ...
        return (
            <div className="card rounded-10 shadow-xss p-4 border-0 mt-n10">
                <div className="card-body text-center">
                    <figure className="avatar ms-auto me-auto mb-0 mt-0 w100"><img src="https://via.placeholder.com/100x100.png" alt="avater" className="shadow-sm rounded-circle w-125" /></figure>

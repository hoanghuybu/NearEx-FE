                        ...
                        <div className="col-lg-12 d-flex">
                            ...
                            <div className="header-search ms-auto me-2 d-flex">
                                <Button onClick={()=>{this.handleModel()}} className="location me-3 bg-transparent border-0">
                                    ...
                                    <h4 className="fw-600 font-xssss mt-0 text-green mb-0 ls-0">Downtown New York..</h4>
                                </Button>
                                ...
                                <Link to="/dashboard" className="nav-icon p-0"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w-40 mt-1 rounded-circle" /></Link>
                            </div>
                        </div>

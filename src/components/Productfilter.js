        ...
        return (
            <div className="side-wrap mb-4">
                <div className="form-group mb-3">
                    <h6 className="fw-600 text-grey-900 font-xsss mb-0 text-capitalize">Đồ Uống - Giải Khát</h6>
                </div>
                ...
                <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="flexCheckBreakfast4">
                ...
                <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="flexCheckGrocery7">
                        Sữa các loại
                    </label>
                    <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                </div>
                <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="flexCheckHousehold8">
                        Bánh Kẹo
                    </label>
                    <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                </div>
                <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="flexCheckMeats9">
                        Trứng - Đậu Hũ
                    </label>
                    <i className="feather-chevron-right mt-1 font-xsss text-grey-500 ms-auto"></i>
                </div>
